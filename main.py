...
def main():
    ...
    maml_model.summary()
    print(get_model_size(maml_model))
    ...
    # train_list = read_dataset("./datasets/" + datasets[2] + "_train")
    # valid_list = read_dataset("./datasets/" + datasets[2] + "_val")
    ...
    # maml_model.save(cfg.save_cnn_path)
    # get_model_weight(maml_model)
    # tf.keras.models.save_model(maml_model, cfg.save_cnn_model_path)
    # tf.saved_model.save(maml_model, cfg.save_cnn_model_path)

    #save model
    # path = cfg.save_ds_path if cfg.quantize_model else cfg.save_cnn_path
    # tf.saved_model.save(maml_model, path)
